  ...
  <div>
    <div class="clearfix">
        ...
        <div class="addtag" style="float:right;margin-top:1em;">
          <el-button type="primary" @click="priDiscount" v-if="hasBtnAuth('B20137',btnApiList)"  v-text="getbtnName('B20137',btnApiList)"></el-button>
          <el-button type="primary" @click="overDiscount" v-if="hasBtnAuth('B20138',btnApiList)"  v-text="getbtnName('B20138',btnApiList)"></el-button>
          <span>催收标签:</span>
