  ...
  <div class="contractDetail">
    ...
    <div class="clearfix">
      <div class="clearfix" style="width:50%;float:left" v-for="param in contractInfo.paramList" :key="param.name">
        <div style="width:33.3%;float:left;line-height:40px;" class="title"><p style="margin:0">{{param.title}}</p></div>
        <div style="width:66.4%;float:left;line-height:40px;"><p style="margin:0">{{valueMap(param)}}</p></div>
      </div>
    </div>
