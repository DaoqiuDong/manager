  ...
  <div>
    <div class="clearfix">
        ...
        <div class="addtag" style="float:right;margin-top:1em;">
          <el-button type="primary" @click="priDiscount" v-if="hasBtnAuth('B20111',btnApiList)"  v-text="getbtnName('B20111',btnApiList)"></el-button>
          <el-button type="primary" @click="overDiscount" v-if="hasBtnAuth('B20112',btnApiList)"  v-text="getbtnName('B20112',btnApiList)"></el-button>
          <span>催收标签:</span>
