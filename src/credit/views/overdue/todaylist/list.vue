  ...
  <div>
    ...
    <div>
      <el-table :data="list"  v-loading.body="loading" :stripe='true'>
        ...
        <el-table-column label="催收时间" prop="lastOverTime" :formatter="(row) => emptyOf(row.lastOverTime)"></el-table-column>
        ...
        <el-table-column label="操作" align="center" min-width="160">
          <template scope="scope">
            ...
            <el-button type="text" @click="getInsert(scope.row)" v-if="hasBtnAuth('B20110',btnApiList)" v-text="getbtnName('B20110',btnApiList)"></el-button>
          </template>
        </el-table-column>
      </el-table>
