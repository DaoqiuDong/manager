    ...
    <div>
        ...
        <div>
          <el-table :data="userList"  v-loading.body="loading" :stripe='true'>
            ...
            <el-table-column label="催收时间" prop="lastOverTime" min-width="140"></el-table-column>
            <el-table-column label="催收人员" prop="lastOverName"></el-table-column>
            <el-table-column label="操作" align="center" min-width="140">
              <template scope="scope">
                <router-link :to="{path:'detail',query:{billId:scope.row.billId,flowId:scope.row.flowId,contractId:scope.row.contractId}}" v-if="hasBtnAuth('B10022',btnGoList)">
