  ...
  <div>
    <div class="clearfix">
        ...
        <div class="addtag" style="float:right;margin-top:1em;">
          <el-button type="primary" @click="priDiscount" v-if="hasBtnAuth('B20080',btnApiList)"  v-text="getbtnName('B20082',btnApiList)"></el-button>
          <el-button type="primary" @click="overDiscount" v-if="hasBtnAuth('B20081',btnApiList)"  v-text="getbtnName('B20083',btnApiList)"></el-button>
          <span>催收标签:</span>
