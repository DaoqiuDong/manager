    ...
    <div>
      <el-table :data="list"  v-loading.body="loading" :stripe='true'>
          ...
          <template scope="props">
            <el-table :data="props.row.billList">
              ...
              <el-table-column label="操作" align="center">
                <template scope="scope">
                  <router-link  :to="{path:'billDetail',query:{id:scope.row.id}}" v-if="hasBtnAuth('B10062',btnGoList)">
                    <el-button type="text" v-text="getbtnName('B10062',btnGoList)"></el-button>
                  </router-link>
                </template>
              </el-table-column>
            </el-table>
        ...
        <el-table-column label="操作" align="center" min-width="140">
          <template scope="scope">
            <router-link :to="{path:'detail',query:{id:scope.row.id}}" v-if="hasBtnAuth('B10045',btnGoList)">
