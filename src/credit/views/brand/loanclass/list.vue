    ...
    <div>
        <el-form :inline='true'>
          ...
          <el-form-item>
            ...
            <router-link :to="{path:'addloanclass'}"  style="float:right" v-if="hasBtnAuth('B10039',btnGoList)">
              <el-button type="primary" v-text="getbtnName('B10039',btnGoList)"></el-button>
            </router-link>
        </el-form>
        ...
        <div>
          <el-table :data="list"  v-loading.body="loading" :stripe='true'>
            ...
            <el-table-column label="更新时间" prop="update_time" min-width="140px"></el-table-column>
            <el-table-column label="产品编号" prop="code"></el-table-column>
            <el-table-column label="产品名称" prop="name"></el-table-column>
            <el-table-column label="排序" prop="order_num"></el-table-column>
            <el-table-column label="额度(万)" prop="amount_txt"></el-table-column>
            <el-table-column label="贷款期限" prop="borrow_days_txt"></el-table-column>
            ...
            <el-table-column label="操作" align="center" v-if="hasBtnAuth('B10031',btnGoList)">
              <template scope="scope">
                <router-link :to="{path:'config',query:{id:scope.row.id}}">
                  <el-button type="text" v-text="getbtnName('B10031',btnGoList)"></el-button>
                </router-link>
              </template>
            </el-table-column>            
          </el-table>
...
export default {
  ...
  methods: {
    ...
    getList(pageNo) {
      ...
      this.ajax({
        url: "credit/web/sys/ad/findLoanList",
        data: {
          pageSize,
          pageNo,
          ...this.searchForm
