    ...
    <div>
        <el-form :inline='true'>
          ...
          <el-form-item>
            ...
            <router-link :to="{path:'addhot'}"  style="float:right" v-if="hasBtnAuth('B10058',btnGoList)">
              <el-button type="primary" v-text="getbtnName('B10058',btnGoList)"></el-button>
            </router-link>
        </el-form>
        ...
        <div>
          <el-table :data="list"  v-loading.body="loading" :stripe='true'>
            ...
            <el-table-column label="排序" prop="bus_status_val"></el-table-column>
            <el-table-column label="UV" prop="click_count"></el-table-column>
            <el-table-column label="操作" align="center" v-if="hasBtnAuth('B10057',btnGoList)">
              <template scope="scope">
                <router-link :to="{path:'config',query:{id:scope.row.id}}">
                  <el-button type="text" v-text="getbtnName('B10057',btnGoList)"></el-button>
                </router-link>
              </template>
            </el-table-column>            
          </el-table>
