    ...
    <div>
      ...
      <el-table :data="list" :stripe='true' style="margin-top:20px"  v-loading.body="loading">
        ...
        <el-table-column label="操作" align="center" min-width="160">
          <template scope="scope">
            <router-link :to="{path:'proConfig',query:{'cpRelId':scope.row.cpRelId,'id':$route.query.id,'type':scope.row.type}}" v-if="hasBtnAuth('B10029',btnGoList)">
            ...
            <router-link :to="{path:'payConfig',query:{'proCode':scope.row.code,'code':corpDetail.code}}" v-if="hasBtnAuth('B10065',btnGoList)">
              <el-button type="text" v-text="getbtnName('B10065',btnGoList)"></el-button>
            </router-link>
          </template>
        </el-table-column>
      </el-table>
