<template>
    <div>
        <div class='flowDetail'>
            <div style="float:right" v-if="pending&&hasBtnAuth('B20028',btnApiList)">
              <span>临时标签:</span>
                  ...
                  <el-col :span="8">
                    <div v-if="pending" class="manual">
                      <el-row :gutter="20">
                        <el-col :span="12">
                          <span>人工审核</span><br/>
                          <span class="pass" @click="passDialog = true" v-if="hasBtnAuth('B20029',btnApiList)" v-text="getbtnName('B20029',btnApiList)"></span>
                        </el-col>
                        <el-col :span="12">
                          <span class="addRemark" @click="addRemarkDialog = true" v-if="hasBtnAuth('B20028',btnApiList)" v-text="getbtnName('B20028',btnApiList)"></span><br/>
                          <span class="refuse" @click="refuseDialog = true" v-if="hasBtnAuth('B20030',btnApiList)" v-text="getbtnName('B20030',btnApiList)"></span>
                        </el-col>
                      </el-row>
                    </div>
                  </el-col>
