<template>
    <div>
        <div class='flowDetail'>
            <div style="float:right" v-if="pending&&hasBtnAuth('B20054',btnApiList)">
              <span>临时标签:</span>
                  ...
                  <el-col :span="16">
                    <div v-if="aduitHistory.length">
                      <el-steps :active="aduitHistory.length + 1">
                        ...
                        <el-step v-if="userInfo.status == 4" title="失效" :description="userInfo.updateTime" status="error"></el-step>
                      </el-steps>
                    </div>
                  </el-col>
                  <el-col :span="8">
                    <div v-if="pending" class="manual">
                      <el-row :gutter="20">
                        <el-col :span="12">
                          <span>人工审核</span><br/>
                          <span class="pass" @click="passDialog = true" v-if="hasBtnAuth('B20055',btnApiList)" v-text="getbtnName('B20055',btnApiList)"></span>
                        </el-col>
                        <el-col :span="12">
                          <span class="addRemark" @click="addRemarkDialog = true" v-if="hasBtnAuth('B20054',btnApiList)" v-text="getbtnName('B20054',btnApiList)"></span><br/>
                          <span class="refuse" @click="refuseDialog = true" v-if="hasBtnAuth('B20056',btnApiList)" v-text="getbtnName('B20056',btnApiList)"></span>
                        </el-col>
                      </el-row>
                    </div>
                  </el-col>
